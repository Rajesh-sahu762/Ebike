...
<h4 class="mb-4">Business Analytics</h4>
...
<h6>Total Revenue</h6>
₹ <asp:Label ID="lblRevenue" runat="server" Font-Size="20px" />
</div>
</div>
...
₹ <asp:Label ID="lblCommission" runat="server" Font-Size="20px" />
</div>
</div>
...
<div class="card p-3 text-center shadow-sm">
<h6>Net Earnings</h6>
₹ <asp:Label ID="lblNet" runat="server" Font-Size="20px" />
</div>
</div>
...
<div class="card p-3 text-center shadow-sm">
<h6>Total Leads</h6>
<asp:Label ID="lblLeads" runat="server" Font-Size="20px" />
</div>
</div>
